...
\decision{Will the charger have to be disabled somehow at startup, and later enabled by the host, to prevent over current to the battery? Can be handled via the $\bar{CE}$ pin.}
